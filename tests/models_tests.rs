...
fn test_space_features_creation() {
    let features = SpaceFeatures {
        ...
        time_tracking: Some(TimeTrackingFeatures {
            enabled: true,
        }),
        tags: Some(TagFeatures {
            enabled: true,
        }),
        time_estimates: Some(TimeEstimateFeatures {
            enabled: true,
        }),
        checklists: Some(ChecklistFeatures {
            enabled: true,
        }),
        custom_fields: Some(CustomFieldFeatures {
            enabled: true,
        }),
        remap_dependencies: Some(DependencyFeatures {
            enabled: true,
        }),
        dependency_warning: Some(DependencyWarningFeatures {
            enabled: true,
        }),
        portfolios: Some(PortfolioFeatures {
            enabled: true,
        }),
    };
